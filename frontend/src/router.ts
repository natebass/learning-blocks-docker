...
export default new Router({
   ...
   *
   * @remarks
   * Route level code-splitting. This generates a separate chunk (about.[hash].js) for this route which is lazy-loaded
   * when the route is visited.
   * Example: /* webpackChunkName: "login" *\/
   *
          ...
          children: [
            ...
            },
            {
              ...
              children: [
                ...
                {
                  path: "edit",
                  component: () => import(/* webpackChunkName: "main-profile-edit" */ "./views/main/profile/UserProfileEdit.vue"),
                },
                {
                  path: "password",
                  component: () => import(/* webpackChunkName: "main-profile-password" */ "./views/main/profile/UserProfileEditPassword.vue"),
                },
              ],
            },
            {
            ...
            {
              path: "aries",
              component: () => import(/* webpackChunkName: "aries" */ "./views/main/admin/Admin.vue"),
              redirect: "aries/reports/all",
              children: [
                {
                  path: "reports",
